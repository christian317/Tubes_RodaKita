        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 p-3">
                ...
                <div class="small fw-semibold text-danger mt-auto">
                    <i class="bi bi-arrow-down-short"></i> Perlu dicek kondisi
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12 col-xl-7">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-header bg-white border-0 pt-4 px-4 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('mitra.monitoringMobil.index') }}" class="btn btn-outline-secondary btn-sm fw-semibold rounded-3">Lihat Semua</a>
                </div>
                        ...
                        <table class="table table-hover align-middle mb-0 px-3">
                            ...
                            <tbody class="border-top">
                                ...
                                <tr>
                                    ...
                                    <td class="pe-4">
                                        <a href="{{ route('mitra.monitoringMobil.index') }}" class="btn btn-light btn-sm fw-semibold text-secondary">Detail</a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
